...
def main():
    ...
    for lamda in [100./50, 100./5, 100., 500.]: 
        for tau_c in [100., 500.]:
            ...
            my_frozen = frozen.FrozenModes(my_ham, nmode=300, ntraj=int(1e3))
            times, rhos_site, rhos_eig = my_frozen.propagate(rho_0, 0.0, 1000.0, 5.0)

            with open('pop_site_tau-%0.1f_lam-%0.2f.dat'%(tau_c,lamda), 'w') as f:
