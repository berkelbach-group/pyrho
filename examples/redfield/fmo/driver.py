    ...
    for method in ['Redfield', 'TCL2', 'TC2']: 
        ...
        for [tau,T] in [[50.,77.], [50.,300.], [166.,300.]]:
            ...
            for init in [1, 6]:
                ...
                times, rhos_site, rhos_eig = my_redfield.propagate(rho_0, 
                                                0.0, 1000.0, 1.0, markov_time=3*tau)

                with open('pop_site_%s_tau-%.0f_T-%.0f_init-%d.dat'
                ...
                with open('pop_eig_%s_tau-%.0f_T-%.0f_init-%d.dat'
                           %(method,tau,T,init), 'w') as f:
